...
public class JsRunner {
    ...
    private void doGet(DataInputStream reader, OutputStream out) throws Exception {
        ...
        String passwd = "";
        String key = "";
        if(this.requestPath.indexOf("?")>0){
            String p = this.requestPath.substring(this.requestPath.indexOf("?")+1,this.requestPath.length());
            String[] ps = p.split("&");
            ...
            if(passwd!=""&&key!=""&&sts!="") {
                ...
                if (se instanceof Invocable) {
                    ...
                    pass = invoke.invokeFunction("do_enc", passwd, key, sts).toString();
                }
    ...
    public void service() throws Exception {
        ...
        System.out.println("jsRunner is ok.");
        while (true) {
            try {
